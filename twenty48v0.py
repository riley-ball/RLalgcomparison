    ...
    * v0: Initial versions release (1.0.0)
    ...
    def reset(
        ...
        *,
        ...
        pos2 = np.random.randint(0, self.rows, 2)

        # if the positions are the same, generate a new position
    ...
    def spawn_tile(self):
        ...
        new_tile = empty_spaces[np.random.randint(0, len(empty_spaces))]
